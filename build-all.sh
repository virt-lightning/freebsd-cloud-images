...
' > ${WORK_DIR}/etc/fstab
    ...
    mkimg -f qcow2 -s gpt -b ${WORK_DIR}/boot/pmbr -p efi:=${WORK_DIR}/boot/boot1.efifat -p freebsd-boot:=${WORK_DIR}/boot/gptboot -p freebsd-swap/swapfs::1G -p freebsd-ufs/rootfs:=./ufs -o freebsd-${VERSION}.raw
